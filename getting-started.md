...
```mermaid
flowchart LR
    A["<a href='javascript:void(0)' onclick=\"window.location.href='https://docs.developer.tech.gov.sg/docs/staging-seed-primer/getting-started#step-0-ensure-you-meet-the-required-prerequisites'\">Step 0: Ensure you meet the required prerequisites</a>"]
